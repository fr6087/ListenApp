...
namespace WcfServiceLibrary
{
    ...
    // Sie können im Projekt XSD-Dateien hinzufügen. Sie können nach dem Erstellen des Projekts dort definierte Datentypen über den Namespace "WcfServiceLibrary.ContractType" direkt verwenden.
    [DataContract]
